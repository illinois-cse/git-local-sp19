...
Hadley sets up their new laptop:
...
Please use your own name and email address instead of Hadley's. This user name and email will be associated with your subsequent Git activity,
...
Hadley also has to set their favorite text editor, following this table:
